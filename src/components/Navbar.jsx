                  ...
                  <div className="relative group">
                    ...
                    <div className="absolute top-11 right-2 z-20 min-w-70 rounded-xl border border-white/10 bg-slate-800/70 px-4 py-4 backdrop-blur-md shadow-xl flex-col gap-2 group-hover:flex hidden">
                      <div className="flex items-center gap-4 text-white hover:bg-gray-400/50 py-2 px-4 rounded-sm cursor-pointer">
                        ...
                        <p className="font-poppins font-normal text-base">Manage My Account</p>
                      </div>
                      <div className="flex items-center gap-4 text-white hover:bg-gray-400/50 py-2 px-4 rounded-sm cursor-pointer">
                        <FiShoppingBag className="text-lg" />
                        <p className="font-poppins font-normal text-base">My Order</p>
                      </div>
                      <div className="flex items-center gap-4 text-white hover:bg-gray-400/50 py-2 px-4 rounded-sm cursor-pointer">
                        <AiOutlineCloseCircle className="text-lg" />
                        <p className="font-poppins font-normal text-base">My Cancellations</p>
                      </div>
                      <div className="flex items-center gap-4 text-white hover:bg-gray-400/50 py-2 px-4 rounded-sm cursor-pointer">
                        <FaRegStar className="text-lg" />
                        <p className="font-poppins font-normal text-base">My Reviews</p>
                      </div>
                      <div className="flex items-center gap-4 text-white hover:bg-gray-400/50 py-2 px-4 rounded-sm cursor-pointer">
                        <TbLogout2 className="text-lg" />
                        <p className="font-poppins font-normal text-base">Logout</p>
                      </div>
                    </div>
                  </div>
                </div>
